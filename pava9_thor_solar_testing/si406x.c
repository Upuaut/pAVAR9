...
static uint16_t si_get_temp()
{
  uint8_t r; 
  uint8_t GPIO_ADC_MSB; 
  uint8_t GPIO_ADC_LSB; 
  uint8_t BATTERY_ADC_MSB; 
  uint8_t BATTERY_ADC_LSB; 
  ...
  BATTERY_ADC_LSB= _spi_transfer(0x00); // Temp ADC
  TEMP_ADC_MSB= _spi_transfer(0x00); // Temp ADC
  TEMP_ADC_LSB= _spi_transfer(0x00); // Temp ADC
